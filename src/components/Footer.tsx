    ...
    <footer className="bg-primary text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center space-x-reverse space-x-2">
              <span className="text-3xl font-black tracking-tighter">{STORE_CONFIG.name}</span>
              <div className="w-2 h-2 rounded-full bg-accent"></div>
            </Link>
            <p className="text-stone-400 text-sm leading-relaxed">
              وجهتكم الأولى للمواد الغذائية والمستلزمات الاحترافية. نقدم لكم أرقى المنتجات المختارة بعناية لتلبية كافة احتياجاتكم.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-stone-400 text-sm">
              ...
              <li><Link to="/categories" className="hover:text-accent transition-colors">المنتجات</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-stone-400 text-sm">
              <li><Link to="/categories" className="hover:text-accent transition-colors">توريد الجملة</Link></li>
              <li><Link to="/contact" className="hover:text-accent transition-colors">طلب عرض سعر</Link></li>
              <li><Link to="/about" className="hover:text-accent transition-colors">حلول قطاع الضيافة</Link></li>
              <li><Link to="/contact" className="hover:text-accent transition-colors">الدعم الفني</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-stone-500 text-xs">
          <p>© {new Date().getFullYear()} {STORE_CONFIG.name}. جميع الحقوق محفوظة.</p>
